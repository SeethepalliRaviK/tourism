...
mlflow.set_tracking_uri("http://0.0.0.0:5000")   # complete the code to set the MLflow tracking URI
mlflow.set_experiment("Tourism Package Prediction Experiment")     # complete the code to set the MLflow experiment name (same as the dev experimentation cell)
...
param_grid = {
    ...
    'xgbclassifier__colsample_bytree': [0.7, 0.8, 1.0],    # Fraction of features sampled when building each tree.
    'xgbclassifier__colsample_bylevel': [0.7, 0.8, 1.0],   # Fraction of features sampled at each tree level.
    ...
    'xgbclassifier__reg_lambda': [0.5, 1.0, 1.5],          # L2 regularization strength. Higher values help reduce overfitting.
}
# Model pipeline
